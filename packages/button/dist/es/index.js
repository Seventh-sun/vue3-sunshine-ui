...
var elForm = createCommonjsModule(function (module, exports) {
  ...
  var script = vue.defineComponent({
    ...
    setup: function setup(props, _ref) {
      ...
      var elForm = vue.reactive(__spreadValues(__spreadProps(__spreadValues({
        formMitt: formMitt
      }, vue.toRefs(props)), {
...
var elButton = createCommonjsModule(function (module, exports) {
  ...
  var script = vue.defineComponent({
    ...
    setup: function setup(props, _ref) {
      ...
      var elForm$1 = vue.inject(elForm.elFormKey, {});
      var elFormItem = vue.inject(elForm.elFormItemKey, {});
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    }, [_ctx.loading ? (vue.openBlock(), vue.createBlock("i", _hoisted_1)) : vue.createCommentVNode("v-if", true), _ctx.icon && !_ctx.loading ? (vue.openBlock(), vue.createBlock("i", {
      key: 1,
      "class": _ctx.icon
    }, null, 2)) : vue.createCommentVNode("v-if", true), _ctx.$slots["default"] ? (vue.openBlock(), vue.createBlock("span", _hoisted_2, [vue.renderSlot(_ctx.$slots, "default")])) : vue.createCommentVNode("v-if", true)], 10, ["disabled", "autofocus", "type"]);
  }
